...
'XM player from  By bLaCk-bytE!
    ...
    CreateFileFromRessource 102, TempPfad & "Mega.XM"
    
     'Bassmod initialisieren und MOD laden + abspielen
    BASSMOD_Init -1, 44100, 0
    BASSMOD_MusicLoad 0, TempPfad & "Mega.XM", 0, 0, 2 Or 512
    BASSMOD_MusicPlay
...
End ' for not this patch rezide to procces
    BASSMOD_MusicStop 'Musik stoppen
    BASSMOD_Free 'Bassmod entladen

    If Dir(TempPfad & "Mega.XM") <> vbNullString Then 'Wenn MOD existiert
        Kill TempPfad & "Mega.XM" 'Dann löschen
    End If
End Sub
